		...
		<div class="header_container">
			...
			<div class="header_button header_right_button header_menu_login">
				...
				<div class="header_menu_user_settings">
					<div class="logged_in" onclick="window.location.href = 'account/settings.html'">Настройки</div>
	...
	<div class="page_container">
		...
		<div id="sidebar_menu">
			<div class="sidebar_menu_body">
				...
				<div class="sidebar_menu_button logged_in"><a href="account/settings.html">Настройки</a></div>
